(function(){
	...
	if($(".homepage")[0] != undefined) {
			...
			$("#menu-item-73 a,#menu-item-756 a").css({
	...
	if($(".showreel")[0] != undefined) {
			...
			$("#menu-item-17 a,#menu-item-931 a").css({
	...
	if($(".work")[0] != undefined) {
			...
			$("#menu-item-16 a,#menu-item-754 a").css({
	...
	if($(".contact")[0] != undefined) {
			...
			$("#menu-item-14 a,#menu-item-752 a").css({
	...
	if($(".about")[0] != undefined) {
			...
			$("#menu-item-15 a,#menu-item-716 a").css({
	...
	if($(".directors")[0] != undefined) {
			...
			$("#menu-item-83 a,#menu-item-757 a").css({
	...
	if($(".blog")[0] != undefined) {
			...
			$("#menu-item-96 a,#menu-item-787 a").css({
